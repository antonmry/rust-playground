...
rustup toolchain install nightly-2024-12-01 --component rust-src
...
TOOLCHAIN_DIR="$HOME/.rustup/toolchains/nightly-2024-12-01-x86_64-unknown-linux-gnu"
...
cargo +nightly-2024-12-01 build --release \
    -Z build-std=core \
...
**Note:** Pinning to `nightly-2024-12-01` avoids recent regressions in the BPF backend while providing Cargo support for
